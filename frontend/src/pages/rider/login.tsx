...
export default function RiderLogin() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await apiClient.post('/api/auth/login', { ...formData, role: loginType });
        ...
        <div className="w-full max-w-md animate-fade-in">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label className="label-tech">
                    {loginType === 'rider' ? 'Rider Email' : 'Club Email'}
                  </Label>
                  <Input
                    type="email"
                    name="email"
                ...
                >
                  {loading ? 'Signing in...' : `Sign In as ${loginType === 'rider' ? 'Rider' : 'Club'}`}
          ...
          <div className="mt-6 text-center space-y-3">
            ...
            <p className="text-sm text-white/40">
              Are you an admin?{' '}
              <Link href="/admin/login" className="font-medium text-white/60 transition-colors hover:text-white">
                Admin login
              </Link>
            </p>
          </div>
